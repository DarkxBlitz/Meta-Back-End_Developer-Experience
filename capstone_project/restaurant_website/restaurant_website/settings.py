...
SECRET_KEY = 'django-insecure-s@0-8^4j=jli9+=fhtp+wp**d!pty6ohhxk42$+yf(i2fvb9a_'
...
STATIC_URL = 'restaurantapi_app/static/'

STATICFILES_DIRS = [
    "restaurantapi_app/static/",
]
...
DJOSER = {
    ...
    #'ACCESS_TOKEN_LIFETIME': timedelta(minutes=5),     #this will make the token expire in 5 minutes
    #"LOGIN_FIELD":"email"
}